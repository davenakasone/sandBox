/*
    burner for fast tests
        if it is importnat, don't store it here
*/

// libraries

////~~~~ The interface of C standard library:
...
#include <locale.h>	// Localization utilities (set commas in numbers)
...
//#include <sys/time.h>    // only seems to work on Linux

// access to macros
#define TEST_VAL 9.4999    // change here
// declared here
// access to functions
// access to global structs
// access to global variables
// access to global constants
// access to testing constants


int main(int argc, char* argv[], char* envp[])
{
    setlocale(LC_NUMERIC, "");
    unsigned long int test = (int)pow(10,9);
    printf("\n\ttest = %lu\n", test);
